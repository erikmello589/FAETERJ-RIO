...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            $perguntas = file("perguntasDiscusiva.txt", FILE_IGNORE_NEW_LINES);
            ...
            foreach ($perguntas as $pergunta) {
                ...
                echo "<form method='post' action='excluir_perguntaDiscursiva.php'>
						<input type='hidden' name='pergunta' value=\"" . $pergunta . "\">
						<input type='submit' class='delete' name='submit' value='Excluir'>
					</form>";
                echo "</td>";
                echo "</tr>";
            }
